...
export const metadata: Metadata = { title:"FraudGuard — Agent IA de détection de fraude", description:"Détectez les transactions frauduleuses en temps réel avec l'IA. FraudGuard analyse chaque paiement et bloque les fraudes avant qu'elles n'impactent votre business." };
